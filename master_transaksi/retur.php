        ...
        <div class="modal-body" style="margin-top: 10px;">
          <form class="form-inline">
            ...
            <form class="form-inline">
              ...
              <select class="theSelect" name="nama-supplier" id="nama-supplier" style="width: 350px;"></select>
            </div>

            <!-- KETERANGAN -->
            <div class="form-group" style="margin-top: 10px;">
                <label for="tanggal-produksi" style="width: 140px;text-align: right;">Keterangan : </label>
                <textarea class="form-control" id="tanggal-produksi" style="width: 350px; margin-left:10px;"></textarea>
              </div>
            </form>
        </div>
        ...
        <div class="modal-body" style="margin-top: 10px;">
          <form class="form-inline">
            ...
            <form class="form-inline">
              ...
              <div class="form-group" style="margin-top: 10px;">
              <label for="nama-supplier" style="width: 140px;text-align: right; margin-right:10px">Nama Supplier : </label>
              <select class="theSelect" name="nama-supplier" id="nama-supplier-ubah" style="width: 350px;"></select>
            </div>

            <!-- KETERANGAN -->
            <div class="form-group" style="margin-top: 10px;">
                <label for="tanggal-produksi" style="width: 140px;text-align: right;">Keterangan : </label>
                <textarea class="form-control" id="tanggal-produksi-ubah" style="width: 350px; margin-left:10px;"></textarea>
              </div>
            </form>
        </div>
