...
<body>
    ...
    <div id="main">
        ...
        <h2>Laporan Pergerakan Bahan Baku</h2>
        ...
        <div class="header-table">
            ...
            <!-- DOWNLOAD -->
            <div onclick="simpan()" style="margin: 0px 20px 0px 20px ;"><span class="iconify" data-icon="ic:baseline-download-for-offline" style="color: #babec8;" data-width="45" data-height="45"></span></div>
